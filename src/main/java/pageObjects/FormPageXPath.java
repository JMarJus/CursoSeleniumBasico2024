...
public class FormPageXPath {
	...
	private By byFirstName = By.xpath("//input[@placeholder='First Name']");
	private By byLastName = By.xpath("//input[@placeholder='Last Name']");
	private By byUserEmail = By.xpath("//input[@placeholder='name@example.com']");
	private By byPhoneNumber = By.xpath("//input[@placeholder='Mobile Number']");
	private By byDateOfBirth = By.xpath("//input[@id='dateOfBirthInput']");
	private By bySubjectsInput = By.xpath("//input[@id='subjectsInput']");
	private By byUploadPicture = By.xpath("//input[@id='uploadPicture']");
	private By byAddress = By.xpath("//textarea[@placeholder='Current Address']");
	private By byState = By.xpath("//input[@id='react-select-3-input']");
	private By byCity = By.xpath("//input[@id='react-select-4-input']");
	private By bySubmit = By.xpath("//button[@type='submit']");
	 ...
	 */
	public FormPageXPath(WebDriver driver, JavascriptExecutor jse) {
		setDriver(driver);
		setJse(jse);
	}
	...
	public void selectRadioButton() {
		genderRadio = seleniumUtils.waitForElement(driver, By.xpath("//input[@id='gender-radio-" + selectedRadio + "']"));
	...
	public void inputHobbies() {
		...
		for (Integer j : selectedCheckBoxes) {
			hobbyCheckBox = seleniumUtils.waitForElement(driver, By.xpath("//input[@id='hobbies-checkbox-" + j + "']"));
